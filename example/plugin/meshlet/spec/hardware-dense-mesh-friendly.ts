...
import { DistanceFieldVolumeData } from './distance-field-volume-data.js';
import { MaterialAsset } from './material-asset.js';
import { Meshlet } from './meshlet.js';
import { SamplerAsset } from './sampler-asset.js';
...
export class HardwareDenseMeshFriendly {
  ...
  static addMeshlets(builder: flatbuffers.Builder, meshletsOffset: flatbuffers.Offset) {
    builder.addFieldOffset(1, meshletsOffset, 0);
  }
  ...
  static addMaterialAsset(builder: flatbuffers.Builder, materialAssetOffset: flatbuffers.Offset) {
    builder.addFieldOffset(2, materialAssetOffset, 0);
  }

  static addSamplerAssets(builder: flatbuffers.Builder, samplerAssetsOffset: flatbuffers.Offset) {
    builder.addFieldOffset(3, samplerAssetsOffset, 0);
  }
  ...
  static addDistanceVolumeData(builder: flatbuffers.Builder, distanceVolumeDataOffset: flatbuffers.Offset) {
    builder.addFieldOffset(4, distanceVolumeDataOffset, 0);
  }
