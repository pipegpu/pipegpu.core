...
/**
 */
const initDepthBias = async (context: Context, compiler: Compiler, colorAttachments: ColorAttachment[], aspect: number, near: number, far: number): Promise<BaseHolder> => {
    ...
    const depthAttachment = compiler.createDepthStencilAttachment({
        ...
        depthLoadStoreFormat: 'clearStore',
        depthBiasSlopeScale: 10000.0,           // if slop scale < 10000.0, z-fighting!
    });
